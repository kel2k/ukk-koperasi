                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button class="btn btn-primary" data-toggle="tooltip" data-placement="bottom"
                                    title="Click to add data" onclick="window.location.href='/home/tambahsimpanan'"><i
                                        class=" fas fa-plus"></i> Add Simpanan</button>
                            </div>
                                ...
                                <table class="table table-bordered table-responsive-sm-down">
                                    ...
                                    foreach ($vsimpanan as $k) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $k->tgl_simpanan ?>
                                            </td>
                                            <td>
                                                <?php echo $k->besar_simpanan ?>
                                            </td>
                                            <td>
                                                <a href="/home/export_pdf3" class="btn btn-danger"><svg
                                                ...
                                                <a href="/home/export_excel3" class="btn btn-primary"><svg
                                                ...
                                                <a href="<?php echo base_url('/home/hapussimpanan/' . $k->id_simpanan) ?>"><button
