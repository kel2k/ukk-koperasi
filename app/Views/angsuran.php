                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button class="btn btn-primary" data-toggle="tooltip" data-placement="bottom"
                                    title="Click to add data" onclick="window.location.href='/home/tambahangsuran'"><i
                                        class="fas fa-plus"></i> Add Angsuran</button>
                            </div>
                                ...
                                <table class="table table-bordered table-responsive-sm-down">
                                    ...
                                    foreach ($vangsuran as $k) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $k->tgl_pembayaran ?>
                                            </td>
                                            <td>
                                                <?php echo $k->besar_angsuran ?>
                                            </td>
                                            <td>
                                                <?php echo $k->kategori_pinjaman ?>
                                            </td>
                                            <td>
                                                <?php echo $k->status_angsuran ?>
                                            </td>
                                            <td>
                                                <a href="/home/export_pdf2" class="btn btn-danger"><svg
                                                ...
                                                <a href="/home/export_excel2" class="btn btn-primary"><svg
                                                ...
                                                <a href="<?php echo base_url('/home/hapusangsuran/' . $k->id_angsuran) ?>"><button
                                                ...
                                                <?php
                                                if ($k->status_angsuran == "Approved") {
                                                    ?>

                                                    <a href="<?php echo base_url('/home/aksi_editstatus6/' . $k->id_angsuran) ?>">
                                                        <button class="btn btn-danger"><i width="16" height="16"
                                                                class="fa fa-window-close"></i>
                                                        </button></a>

                                                    <?php
                                                } else if ($k->status_angsuran == "Not Approved") {
                                                    ?>

                                                        <a href="<?php echo base_url('/home/aksi_editstatus5/' . $k->id_angsuran) ?>">
