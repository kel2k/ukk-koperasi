                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/home/pinjaman"
                                    aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="16" fill="currentColor"
                                        class="bi bi-person-badge-fill" viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <span class="hide-menu" style="margin-left: 10px;">Pinjaman</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/home/angsuran"
                                    aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="16" fill="currentColor"
                                        class="bi bi-person-badge-fill" viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <span class="hide-menu" style="margin-left: 10px;">Angsuran</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/home/simpanan"
                                    aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="16" fill="currentColor"
                                        class="bi bi-person-badge-fill" viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <span class="hide-menu" style="margin-left: 10px;">Simpanan</span>
                                </a>
                            </li>
                            </li>
                        </ul>
                                            ...
                                            <ul id="sidebarnav">
                                                ...
                                                <li class="sidebar-item">
                                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                        href="/home/pinjaman" aria-expanded="false">
                                                ...
                                                <li class="sidebar-item">
                                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                        href="/home/angsuran" aria-expanded="false">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="16"
                                                            fill="currentColor" class="bi bi-person-badge-fill"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                ...
                                                <li class="sidebar-item">
                                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                        href="/home/simpanan" aria-expanded="false">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="16"
                                                            fill="currentColor" class="bi bi-person-badge-fill"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                    ...
                                                                    <li class="sidebar-item">
                                                                        <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                                            ...
                                                                            <span class="hide-menu"
                                                                                style="margin-left: 10px;">Pinjaman</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="sidebar-item">
                                                                        <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                                            ...
                                                                            <span class="hide-menu"
                                                                                style="margin-left: 10px;">Angsuran</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="sidebar-item">
                                                                        <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                                            ...
                                                                            <span class="hide-menu"
                                                                                style="margin-left: 10px;">Simpanan</span>
                                                                        </a>
                                                                    </li>
                                                                    </li>
                                                                </ul>
